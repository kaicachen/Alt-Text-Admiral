...
def create_pdf(file_name):
    ...
    with open(os.path.join("app", "app_code", "outputs", "CSVs", f"{file_name}.csv"), mode="r", newline="", encoding="utf-8") as file:
    ...
    c = canvas.Canvas(os.path.join("app", "app_code", "outputs", "PDFs", f"{file_name}.pdf"), pagesize=letter)
    width, height = letter
